...
With the *exception* of code contributed by others (such as sen.fish), the remaining text of this article is licensed under [Creative Commons CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) and free to use for any purpose.